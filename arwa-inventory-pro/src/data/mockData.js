export const SUBSCRIPTION_PLANS = {
  ...
  super: {
    ...
    locked: ['AI Intelligence add-ons (available separately)'],
  },
};
...
export const AI_ADDONS = {
  selfHealing: {
    ...
    subtitle: 'Automatic system repair',
    monthlyPrice: 99,
    yearlyPrice: 990,
    icon: '🛠️',
  ...
  workflowAutomation: {
    ...
    subtitle: 'Trigger-based business automation',
    monthlyPrice: 49,
    yearlyPrice: 490,
    icon: '⚡',
    gradient: 'linear-gradient(135deg, #F59E0B, #EF4444)',
    features: [
      'Auto purchase orders at reorder point',
